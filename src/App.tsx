...
import { Search, Plus, Play, Tag as TagIcon, X, Info, Trash2, FastForward, Rewind, Pause } from 'lucide-react';
...
function App() {
  ...
  return (
    <div className="flex h-screen bg-[#121212] text-white overflow-hidden font-sans">
      ...
      {/* LEFT SIDE: VIDEO CANVAS (~75%) */}
      <div className="w-3/4 h-full relative bg-black flex flex-col items-center justify-center shadow-[4px_0_24px_rgba(0,0,0,0.5)] z-10">
        {currentVideo ? (
          ...
          <div className="text-neutral-500 flex flex-col items-center gap-4">
            ...
            <p className="text-lg tracking-wide font-light">Select a video to play</p>
          </div>
        )}
      </div>

      {/* RIGHT SIDE: MANAGER PANEL (~25%) */}
      <div className="w-1/4 h-full bg-[#181818] flex flex-col z-20">
